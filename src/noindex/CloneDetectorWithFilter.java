...
public class CloneDetectorWithFilter {
    ...
    private float threshold; // threshold for matching the clones.e.g. .8 or
                             // .9
    private Map<String, List<TokenFrequency>> bagToListMap; // Changed the map from <Long, ..> to <String, ...> - Sarah
    ...
    public CloneDetectorWithFilter() {
        super();
        this.threshold = 1F;
        this.bagToListMap = new HashMap<String, List<TokenFrequency>>(); // Changed the map from <long, ..> to <String, ...>
